...
{
    public abstract class BookReviewWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookReviewWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookReviewWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookReviewDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookReviewDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookReviewDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookReviewDbContext, Task<T>> func)
        {
            T result;
